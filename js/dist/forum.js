...
flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.initializers.add('justoverclock/flarum-ext-newsletter', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'navItems', function (navItems) {
    if (flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.current.matches(flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_1___default.a)) navItems.add('Newsletter', m('div', {
      className: 'alignews'
    }, m('h1', {
      id: 'titleNl'
...
Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'oncreate', function () {
  ...
  jQuery(function () {
    var pubAcc = flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.forum.attribute('PubAccount');
    var listmail = flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.forum.attribute('ListName');
    SetupNewsletterSubscribe(pubAcc, listmail, 'subscribeForm', function () {
      var thankU = flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('flarum-ext-newsletter.forum.modalthanku');
      var ModalText = flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('flarum-ext-newsletter.forum.modaltext'); // Inseriamo il popup con le variabili per la traduzione.
